  ...
  return (
    <>
      ...
      <Box sx={{ aspectRatio: { xs: '9/12', md: 'auto' } }}>
        <Image src='/technologies.svg' width={1920} height={1080} alt='Technologies' style={{ width: '-webkit-fill-available', height: '-webkit-fill-available', objectFit: 'cover', objectPosition: 'center' }} />
      </Box>
    </>
  );
};